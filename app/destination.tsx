...
const DestinationScreen = () => {
  ...
  const [prevSelectedDestination, setPrevSelectedDestination] = useState([]);
  ...
  const handleSelectAutoComplete = async (item: any) => {
    const updatedCities = [...prevSelectedDestination];
    ...
    setPrevSelectedDestination(updatedCities);
    setFlightOfferData({
      ...flightOfferData,
      ...
      <View className="w-full h-full">
        ...
        <View className="w-full p-4 relative">
          ...
          <View className="w-full">
            {prevSelectedDestination.length > 0 && (
